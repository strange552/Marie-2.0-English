...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("{} is offline ! ".format(update.effective_user.first_name))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        update.effective_message.reply_text("{} is online now !".format(update.effective_user.first_name))
